...
import 'package:erestro/data/localDataStore/authLocalDataSource.dart';
import 'package:erestro/data/repositories/auth/authRemoteDataSource.dart';
...
class AuthRepository {
  ...
  Future<Map<String, dynamic>> signInUser(AuthProvider authProvider, String? referCode, String? friendCode) async {
    try {
