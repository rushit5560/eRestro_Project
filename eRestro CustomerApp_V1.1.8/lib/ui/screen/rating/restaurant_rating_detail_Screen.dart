...
import 'package:erestro/cubit/rating/deleteRatingCubit.dart';
import 'package:erestro/cubit/rating/getRestaurantRatingCubit.dart';
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    return hasMore && restaurantRatingList.isEmpty && index == (restaurantRatingList.length - 1)
                        ...
                        : Container(
                            ...
                            decoration:
                                DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0),
                            child: Column(
                              children: [
                                Padding(
