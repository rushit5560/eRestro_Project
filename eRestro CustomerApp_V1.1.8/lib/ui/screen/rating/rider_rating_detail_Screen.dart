...
import 'package:erestro/cubit/rating/getRiderRatingCubit.dart';
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    return hasMore && riderRatingList.isEmpty && index == (riderRatingList.length - 1)
                        ...
                        : Container(
                            ...
                            decoration:
                                DesignConfig.boxDecorationContainerCardShadow(Theme.of(context).colorScheme.onBackground, shadowBottomBar, 15.0, 0.0, 0.0, 10.0, 0.0),
                            child: Column(
                              children: [
                                Row(
                                                  ...
                                                  Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Icon(Icons.star, color: Theme.of(context).colorScheme.onBackground, size: 15.0),
                                                        ],
                                                      )),
                                                ],
                                              ),
