            ...
            : Scaffold(
                ...
                bottomNavigationBar: BlocConsumer<SetRiderRatingCubit, SetRiderRatingState>(
                    ...
                    builder: (context, state) {
                      ...
                      return ButtonContainer(color: Theme.of(context).colorScheme.secondary, height: height, width: width, text: UiUtils.getTranslatedLabel(context, submitLabel), start: width! / 40.0, end: width! / 40.0, bottom: height! / 55.0, top: 0, status: false,borderColor: Theme.of(context).colorScheme.secondary, textColor: white, onPressed: () async {
                      context
