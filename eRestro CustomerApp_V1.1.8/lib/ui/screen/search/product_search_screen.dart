...
import 'package:erestro/cubit/home/search/productSearchCubit.dart';
...
import 'package:erestro/ui/widgets/productItemContainer.dart';
...
class ProductSearchScreenState extends State<ProductSearchScreen> {
                  ...
                  Container(
                      ...
                      child: Container(
                        decoration: DesignConfig.boxDecorationContainerRoundHalf(
                            Theme.of(context).colorScheme.onBackground, 25, 0, 25, 0),
                        child: Container(
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(statusFoodType == "" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onBackground, 15.0),
                                    ...
                                    onTap: () {
                                      if (dataItem.partnerDetails![0].isRestroOpen == "1") {
                                        ...
                                        if(dataItem.availableTime=="1"){
                                          if(check==true){
                                            bottomModelSheetShow(productSearchList, i);
                                          }else{
                                            showDialog(
                                              context: context,
  ...
  Widget searchBar() {
    return Container(
        decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.background, 10.0),
