...
import 'package:erestro/ui/widgets/simmer/categoryVerticallySimmer.dart';
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(statusFoodType == "3" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onBackground, 15.0),
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      width: width,
                      padding: EdgeInsetsDirectional.only(top: height! / 55.0, bottom: height! / 55.0, start: width! / 99.0, end: width! / 99.0),
                      decoration: DesignConfig.boxDecorationContainer(statusFoodType == "1" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onBackground, 15.0),
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      width: width,
                      padding: EdgeInsetsDirectional.only(top: height! / 55.0, bottom: height! / 55.0, start: width! / 99.0, end: width! / 99.0),
                      decoration: DesignConfig.boxDecorationContainer(statusFoodType == "2" ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onBackground, 15.0),
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              width: 12.1, height: 11.5, color: statusRating == "1" ? Theme.of(context).colorScheme.onBackground : Theme.of(context).colorScheme.primary),
              ...
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              width: 12.1, height: 11.5, color: statusRating == "2" ? Theme.of(context).colorScheme.onBackground : Theme.of(context).colorScheme.primary),
                          SizedBox(width: width! / 99.0),
                          Text("2",
                              textAlign: TextAlign.center,
                              maxLines: 1,
              ...
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              width: 12.1, height: 11.5, color: statusRating == "3" ? Theme.of(context).colorScheme.onBackground : Theme.of(context).colorScheme.primary),
                          SizedBox(width: width! / 99.0),
                          Text("3",
                              textAlign: TextAlign.center,
                              maxLines: 1,
              ...
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              width: 12.1, height: 11.5, color: statusRating == "4" ? Theme.of(context).colorScheme.onBackground : Theme.of(context).colorScheme.primary),
                          SizedBox(width: width! / 99.0),
                          Text("4",
                              textAlign: TextAlign.center,
                              maxLines: 1,
              ...
              child: InkWell(
                  ...
                  child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(DesignConfig.setSvgPath("restaurant_rating"),
                              width: 12.1, height: 11.5, color: statusRating == "5" ? Theme.of(context).colorScheme.onBackground : Theme.of(context).colorScheme.primary),
                          SizedBox(width: width! / 99.0),
                          Text("5",
                              textAlign: TextAlign.center,
                              maxLines: 1,
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              ...
              body: Container(
                ...
                decoration: DesignConfig.boxDecorationContainerHalf(Theme.of(context).colorScheme.onBackground),height: height!,
                width: width,
