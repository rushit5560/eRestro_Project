...
/*
  ...
  Widget _offsetPopup() => PopupMenuButton<String>(
        ...
        icon: Container(
            ...
            decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onSecondary, 10.0),
            child: Lottie.asset(
              DesignConfig.setLottiePath('menu_list'),
            )),
        iconSize: 50,
      );
  ...
  void showMemberMenu() async {
    ...
    await showMenu(
      ...
      color: Theme.of(context).colorScheme.onSecondary,
      context: context,
      position: RelativeRect.fromLTRB(200, height! / 1.7, width! / 20.0, height! / 99.0),
      items: List.generate(
        menuList.length,
        (index) => PopupMenuItem(
          value: 1,
          child: Text(
            menuList[index],
            style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: white),
          ),
          onTap: () {
              ...
              body: RefreshIndicator(
                ...
                child: BlocConsumer<RestaurantCuisineCubit, RestaurantCuisineState>(
                    ...
                    builder: (context, state) {
                      ...
                      final categoryList = (state as RestaurantCuisineSuccess).restaurantCuisineList;
