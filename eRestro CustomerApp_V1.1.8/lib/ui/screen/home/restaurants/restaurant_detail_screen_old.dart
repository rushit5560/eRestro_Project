...
import 'package:erestro/ui/widgets/simmer/bottomCartSimmer.dart';
import 'package:erestro/ui/widgets/bottomSheetContainer.dart';
import 'package:erestro/ui/widgets/productItemContainer.dart';
import 'package:erestro/ui/widgets/simmer/restaurantDetailSimmer.dart';
                              ...
                              SliverLayoutBuilder(builder: (context, constraints) {
                                return SliverAppBar(
                                  ...
                                  iconTheme: IconThemeData(
                                    color: constraints.scrollOffset >= 200 ? Theme.of(context).colorScheme.onSecondary : Theme.of(context).colorScheme.onBackground,
                                  ),
                                  floating: false,
                                  pinned: true,
                                  ...
                                  leading: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: DesignConfig.boxDecorationContainer(
                                          constraints.scrollOffset >= 350 ? Theme.of(context).colorScheme.onBackground : greayLightColor.withOpacity(0.70), 5.0),
                                      child: Icon(
                                        Icons.arrow_back,
                                        color: constraints.scrollOffset >= 350 ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onBackground,
                                      ),
                                    ),
                                  ),
                                  actions: [
                                          ...
                                          return BlocBuilder<FavoriteRestaurantsCubit, FavoriteRestaurantsState>(
                                              ...
                                              builder: (context, favoriteRestaurantState) {
                                                ...
                                                return Container(
                                                  ...
                                                  margin: const EdgeInsetsDirectional.only(top: 12, bottom: 12, start: 10.0, end: 10.0),
                                                  decoration: DesignConfig.boxDecorationContainer(
                                                      constraints.scrollOffset >= 350 ? Theme.of(context).colorScheme.onBackground : greayLightColor.withOpacity(0.70),
                                                      5.0),
                                                  child: InkWell(
                                                      onTap: () {
