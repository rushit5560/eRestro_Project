...
import 'package:erestro/data/model/addOnsDataModel.dart';
import 'package:erestro/data/model/delivery_tip_model.dart';
import 'package:erestro/data/model/productAddOnsModel.dart';
import 'package:erestro/data/model/sectionsModel.dart';
import 'package:erestro/data/model/variantsModel.dart';
...
import 'package:erestro/ui/styles/dashLine.dart';
...
import 'package:erestro/ui/screen/offerCoupons/offer_coupons_screen.dart';
import 'package:erestro/ui/screen/settings/no_internet_screen.dart';
import 'package:erestro/ui/widgets/simmer/addressSimmer.dart';
import 'package:erestro/ui/widgets/bottomSheetContainer.dart';
import 'package:erestro/ui/widgets/simmer/buttonSimmer.dart';
    ...
    return Container(alignment: Alignment.center,
        ...
        child: Center(
          child: TextField(
            ...
            decoration: InputDecoration(contentPadding: EdgeInsetsDirectional.zero,
          ...
          children: [
                        ...
                        itemBuilder: (BuildContext context, index) {
                          return InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: deliveryTip == double.parse(deliveryTipList[index].price!) ? DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.primary, Theme.of(context).colorScheme.primary.withOpacity(0.10), 10.0) : DesignConfig.boxDecorationContainerBorder(commentBoxBorderColor,textFieldBackground, 10.0),
                                child: Text(context.read<SystemConfigCubit>().getCurrency() + deliveryTipList[index].price!,
                                    textAlign: TextAlign.center,
                                    maxLines: 1,
                                    style: TextStyle(
                                        color:
                                            deliveryTip == double.parse(deliveryTipList[index].price!) ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSecondary,
                                        fontSize: 12,
            ...
            InkWell(
                ...
                child: Container(
                  ...
                  decoration: tipOther == true ? DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.primary, Theme.of(context).colorScheme.primary.withOpacity(0.10), 10.0) : DesignConfig.boxDecorationContainerBorder(commentBoxBorderColor,textFieldBackground, 10.0),
                  child: Text(UiUtils.getTranslatedLabel(context, otherLabel),
                      textAlign: TextAlign.center,
                      maxLines: 1,
                      style:
                          TextStyle(color: tipOther == true ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w500)),
                )),
            tipOther == true
                ? Expanded(
                    child: Row(
                          ...
                          onTap: () {
                            setState(() {
                              if (deliveryTipController.text.trim().isNotEmpty) {
                                ...
                                UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, deliveryTipLabel), StringsRes.addTip, context, false, type: "2");
                              }
                            });
                          },
                          child: Container(
                            ...
                            child: Text(
                              deliveryTipController.text.trim().isNotEmpty ? UiUtils.getTranslatedLabel(context, addLabel) : UiUtils.getTranslatedLabel(context, cancelLabel),
                        ...
                        child: Container(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.start, mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                                            ...
                                            ? SvgPicture.asset(DesignConfig.setSvgPath("veg_icon"), width: 15, height: 15)
                                              ...
                                              Expanded(
                                                  child: Text(productDetailsModel.name!,
                                                      ...
                                                      style: TextStyle(
                                                          color: Theme.of(context).colorScheme.onSecondary, fontSize: 16, fontWeight: FontWeight.w500, fontStyle:  FontStyle.normal,))),
                                                          Row(
                                            children: [
                                              Text(context.read<SystemConfigCubit>().getCurrency() + priceCurrent.toString(),
                                                  textAlign: TextAlign.left,
                                                  style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.w700)),
                                            ],
                                          ),
                                  ],
                                ),
                              ...
                              Row(children:[
                                Expanded(
                                  child: ButtonContainer(color: Theme.of(context).colorScheme.secondary, height: height, width: width, text: UiUtils.getTranslatedLabel(context, addNewItemLabel), start: 0, end: width! / 40.0, bottom: height! / 55.0, top: 0, status: false,borderColor: Theme.of(context).colorScheme.secondary, textColor: white, onPressed: (){
                                  ...
                                  BlocConsumer<ManageCartCubit, ManageCartState>(
                                    ...
                                    if (state is ManageCartSuccess) {
                                      if (context.read<AuthCubit>().state is AuthInitial ||
                                        ...
                                        Navigator.pop(context);
                                        context.read<ValidatePromoCodeCubit>().getValidatePromoCode(promoCode, context.read<AuthCubit>().getId(), state.subTotal);
                                        }
                                      ...
                                      return Expanded(
                                        child: ButtonContainer(color: Theme.of(context).colorScheme.onBackground, height: height, width: width, text: UiUtils.getTranslatedLabel(context, repeatItemLabel), start: 0, end: width! / 99.0, bottom: height! / 55.0, top: 0, status: false,borderColor: Theme.of(context).colorScheme.secondary, textColor: Theme.of(context).colorScheme.onSecondary, onPressed: (){
                                          setState(() {
                                            if(qty < int.parse(productDetailsModel.minimumOrderQuantity!)){
                                              Navigator.pop(context);
                                              UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, quantityLabel), "${StringsRes.minimumQuantityAllowed} ${productDetailsModel.minimumOrderQuantity!}", context, false,
                                              type: "2");
                                                          ...
                                                          return GestureDetector(
                                                            ...
                                                            child: Container(
                                                              decoration: addressList[index].isDefault == "1"
                                                                  ...
                                                                  : DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.onBackground, Theme.of(context).colorScheme.onBackground, 15),
              ...
              for (int j = 0; j < productDetails[i].variants!.length; j++) {
                if (productVariantId!.contains(productDetails[i].variants![j].id)) {
                  String qty = (await db.checkCartItemExists(
                      productDetails[i].id!, productDetails[i].variants![j].id!))!;
                  ...
                  if (price == 0) {
                    price =
                        double.parse(productDetails[i].variants![j].price!);
                  }
      ...
      return (context.read<AuthCubit>().state is AuthInitial || context.read<AuthCubit>().state is Unauthenticated)
          ? BlocConsumer<OfflineCartCubit, OfflineCartState>(
              ...
              builder: (context, state) {
                ...
                restaurantName = offlineCartList.isEmpty?UiUtils.getTranslatedLabel(context, myCartLabel):offlineCartList[0].partnerDetails![0].partnerName!;
                        ...
                        child: Container(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0), margin: EdgeInsetsDirectional.only(start: width!/40.0, end: width!/40.0), padding: EdgeInsetsDirectional.only(top: height!/80, start: width!/40.0, bottom: height!/80.0, end: width!/40.0),
                                    child: Column(mainAxisSize: MainAxisSize.min, children:[
                                      Row(children:[
                                        Text(UiUtils.getTranslatedLabel(context, yourOrderLabel),
                                              style: TextStyle(
                                              fontSize: 14, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.w500),
                                            ),
                                            const Spacer(),
                                              ...
                                              listener: (context, state) {
                                                if (state is ClearCartSuccess) {
                                                  if (context.read<AuthCubit>().state is AuthInitial ||
                                                    ...
                                                    UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, cartLabel), UiUtils.getTranslatedLabel(context, clearCartLabel), context, false, type: "1");
                                                    //context.read<GetCartCubit>().getCartUser(userId: context.read<AuthCubit>().getId());
                                                  }
                                                  ...
                                                  if (context.read<AuthCubit>().state is AuthInitial ||
                                                    ...
                                                    UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, cartLabel), state.errorMessage, context, false, type: "2");
                                                  }
                                                }
                                              },
                                              builder: (context, state) {
                                        ...
                                        return SizedBox(
                                                ...
                                                child: Container(
                                                      ...
                                                      child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                                                          children:
                                                              List.generate(offlineCartList[i].variants!.length, (l) {
                                                                          ...
                                                                          children: [
                                                                            offlineCartList[i].image!.isEmpty
                                                                                      ...
                                                                                      : ClipRRect(
                                                                                          borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                                                                                          child: ColorFiltered(
                                                                                            colorFilter: offlineCartList[i].partnerDetails![0].isRestroOpen == "1"
                                                                                            ...
                                                                                            child: Column(mainAxisSize: MainAxisSize.min,
                                                                                                ...
                                                                                                children: [
                                                                                                  Row(mainAxisAlignment: MainAxisAlignment.start, mainAxisSize: MainAxisSize.min,children:[
                                                                                                    ...
                                                                                                    Expanded(flex: 2,
                                                                                                    child: Text("${variantData.cartCount!} x ${offlineCartList[i].name!}",//Text("${snapshot.data} x ${offlineCartList.data![i].name!}",
                                                                                      ...
                                                                                      off.toStringAsFixed(2) == "0.00" ||
                                                                                          ...
                                                                                          : Text(
                                                                                              context
                                                                                                      .read<SystemConfigCubit>()
                                                                                                      .getCurrency() +
                                                                                                  (double.parse(variantData.price!.toString())*int.parse(variantData.cartCount!.toString())).toStringAsFixed(2),
                                  ...
                                  Padding(
                                    ...
                                    child: GestureDetector(
                                          ...
                                          child: Row(
                                          children: [
                                            Icon(Icons.add, color: Theme.of(context).colorScheme.primary, size: 20.0), const SizedBox(width: 2.0),
                                            Text(UiUtils.getTranslatedLabel(context, addMoreFoodInCartLabel),
                                                textAlign: TextAlign.start,
                                                style: TextStyle(color: Theme.of(context).colorScheme.primary, fontSize: 12, fontWeight: FontWeight.w500, fontStyle:  FontStyle.normal,)),
                                          ],
                                                                              ),
                                        )
                                  ...
                                  Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0), margin: EdgeInsetsDirectional.only(start: width!/40.0, end: width!/40.0, top: height!/60.0), padding: EdgeInsetsDirectional.only(top: height!/80, start: width!/40.0, end: width!/40.0, bottom: height!/80.0),
                                        ...
                                        return Padding(
                                          ...
                                          child: Row(children: [
                                            Text(UiUtils.getTranslatedLabel(context, totalPayLabel),
                                                textAlign: TextAlign.left,
                                                style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 15, fontWeight: FontWeight.w700)),
                                            const Spacer(),
                                            Text(
                                                /* context.read<SystemConfigCubit>().getCurrency() + state.settingsModel!.cartTotal.toString() == ""
                                                    ? "0"
                                                    : double.parse(state.settingsModel!.cartTotal.toString()).toStringAsFixed(2), */oriPrice.toStringAsFixed(2),
                                                textAlign: TextAlign.end,
                                                style: TextStyle(
                                                    color: Theme.of(context).colorScheme.onSecondary, fontSize: 15, fontWeight: FontWeight.w700, letterSpacing: 0.8)),
                                          ]),
                                        );
                                      }),
                                      ])
          ...
          : context.read<SettingsCubit>().state.settingsModel!.cartCount == "0" && context.read<AuthCubit>().getId() == "0.0"
              ? noCartData()
                    ...
                    return cartList.totalQuantity == ""
                        ...
                        : Container(
                                      ...
                                      cartList.data![0].productDetails![0].partnerDetails![0].permissions!.deliveryOrders == "1"
                                          ? Expanded(
                                            child: GestureDetector(
                                              ...
                                              child: Container(width: width!, decoration: DesignConfig.boxDecorationContainer(orderTypeIndex==0?Theme.of(context).colorScheme.primary: Theme.of(context).colorScheme.onBackground, 10.0), margin: EdgeInsetsDirectional.only(start: width!/40.0), padding: EdgeInsetsDirectional.only(top: height!/70.0, bottom: height!/70.0),
                                                child: Column(
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: [
                                                      SvgPicture.asset(DesignConfig.setSvgPath("delivery"), colorFilter: ColorFilter.mode(orderTypeIndex==0?Theme.of(context).colorScheme.onBackground: Theme.of(context).colorScheme.onSecondary, BlendMode.srcIn)),
                                                      const SizedBox(height: 5.0),
                                                      Text(
                                                        UiUtils.getTranslatedLabel(context, deliveryLabel),
                                                        style: TextStyle(
                                                            color: orderTypeIndex==0?white: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.normal),
                                                      ),
                                                    ],
                                                  ),
                                              ),
                                      ...
                                      cartList.data![0].productDetails![0].partnerDetails![0].permissions!.selfPickup == "1"
                                          ? Expanded(
                                            child: GestureDetector(
                                              ...
                                              child: Container(width: width!, decoration: DesignConfig.boxDecorationContainer(orderTypeIndex==1?Theme.of(context).colorScheme.primary:Theme.of(context).colorScheme.onBackground, 10.0), margin: EdgeInsetsDirectional.only(start: width!/40.0, end: width!/40.0), padding: EdgeInsetsDirectional.only(top: height!/70.0, bottom: height!/70.0),
                                                child: Column(
                                                    children: [
                                                      SvgPicture.asset(DesignConfig.setSvgPath("pickup"), colorFilter: ColorFilter.mode(orderTypeIndex==1?Theme.of(context).colorScheme.onBackground: Theme.of(context).colorScheme.onSecondary, BlendMode.srcIn)),
                                                      const SizedBox(height: 5.0),
                                                      Text(
                                                        UiUtils.getTranslatedLabel(context, pickupLabel),
                                                        style: TextStyle(
                                                            color: orderTypeIndex==1?white: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.normal),
                                                      ),
                                                    ],
                                                  ),
                                              ),
                                                        ...
                                                        itemBuilder: (BuildContext context, i) {
                                                          ...
                                                          return state.addressList[i].isDefault == "0"
                                                              ...
                                                              : Container(
                                                                  ...
                                                                  padding: EdgeInsetsDirectional.only(
                                                                      bottom: height! / 99.0/* , start: width! / 40.0, end: width! / 40.0 */),
                                                                  child: Column(children: [
                                                                    Row(children: [
                                                                      ...
                                                                      SizedBox(width: height! / 99.0),
                                                                      Text(
                                                                        state.addressList[i].type!/*  == StringsRes.home
                                                                            ? StringsRes.home
                                                                          ...
                                                                          child: Text("${cartList.data![i].qty!} x ${cartList.data![i].name!}",
                                                                            ...
                                                                            maxLines: 1,
                                                                                ...
                                                                                Column(
                                                                                    ...
                                                                                    if (state is ManageCartSuccess) {
                                                                                      if (context.read<AuthCubit>().state is AuthInitial ||
                                                                                        ...
                                                                                        context.read<GetCartCubit>().updateCartList(currentCartModel.updateCart(
                                                                                            ...
                                                                                            cartList.data![i].productVariantId.toString());
                                                                                        print(currentCartModel.variantId);
                                                                                        context
                                                                                  ...
                                                                                  builder: (context, state) {
                                                                            return Container(alignment: Alignment.center, height: 25.0, width: width!/4.8, decoration: DesignConfig.boxDecorationContainerBorder(
                                                                                commentBoxBorderColor, textFieldBackground, 5.0),
                                                                            //padding: const EdgeInsetsDirectional.only(top: 6.5, bottom: 6.5),
                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                                                                BlocConsumer<RemoveFromCartCubit, RemoveFromCartState>(
                                                                                          ...
                                                                                          onTap: () {
                                                                                            setState(() {
                                                                                              ...
                                                                                              context.read<RemoveFromCartCubit>().removeFromCart(
                                                                                                ...
                                                                                                cartList.data![i].qty = (int.parse(cartList.data![i].qty!) -1).toString();
                                                                                                /* if (int.parse(cartList.data![i].qty!) <= int.parse(cartList.data![i].minimumOrderQuantity!)) {
                                                                                ...
                                                                                Padding(
                                                                                  ...
                                                                                  child: InkWell(
                                                                                    onTap:(){
                                                                                      if(cartList.data![i].productDetails![0].type=="variable_product"){
                                                                                      ...
                                                                                      setState(() {
                                                                                          if(int.parse(cartList.data![i].qty!) < int.parse(cartList.data![i].productDetails![l].minimumOrderQuantity!)){
                                                                                            Navigator.pop(context);
                                                                                            UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, quantityLabel), "${StringsRes.minimumQuantityAllowed} ${cartList.data![i].productDetails![l].minimumOrderQuantity!}", context, false,
                                                                                            type: "2");
                                                                                          }else if (int.parse(cartList.data![i].qty!) >= int.parse(cartList.data![i].productDetails![l].totalAllowedQuantity!)) {
                                                                                      ...
                                                                                      child: Icon(Icons.add, color: Theme.of(context).colorScheme.onSecondary, size: 15.0)),
                                                                                                ...
                                                                                                Row(mainAxisAlignment: MainAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                                                                                                  children: [
                                                                                                    (cartList.data![i].productDetails![j].type=="variable_product")?InkWell(
                                                                                                  onTap: () {
                                                                                                    setState(() {
                                                                                                      bottomModelSheetShowEdit(
                                                                                                    ...
                                                                                                    Row(mainAxisSize:MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                                                                                      Text(
                                                                                                          context
                                                                                                                  .read<SystemConfigCubit>()
                                                                                                                  .getCurrency() +
                                                                                                              (double.parse(price.toString())*int.parse(cartList.data![i].qty!)).toStringAsFixed(2),
                                                                                                          textAlign: TextAlign.center,
                                                                                                          style: TextStyle(
                                                                                                              color: Theme.of(context).colorScheme.onSecondary,
                                                                                                              fontSize: 13,
                                                                                                      ...
                                                                                                      off.toStringAsFixed(2) == "0.00" ||
                                                                                                          ...
                                                                                                          : Text(
                                                                                                              context
                                                                                                                      .read<SystemConfigCubit>()
                                                                                                                      .getCurrency() +
                                                                                                                  (double.parse(cartList.data![i].price!)).toStringAsFixed(2),
                                                                                                              style: const TextStyle(
                                                                                                                  decoration:
                                      ...
                                      Navigator.push(
                                        ...
                                        if (value != null) {
                                          setState(() {
                                            ...
                                            context
                                                .read<ValidatePromoCodeCubit>()
                                                .getValidatePromoCode(promoCode, context.read<AuthCubit>().getId(), cartList.subTotal);
                                            if (orderTypeIndex.toString() == "0") {
                                                  ...
                                                  return Row(
                                                    children: [
                                                      ...
                                                      Text(
                                                          ...
                                                          textAlign: TextAlign.start,
                                                          style:
                                                              TextStyle(color: Theme.of(context).colorScheme.onPrimary, fontSize: 12, fontWeight: FontWeight.w700))
                            ...
                            bottom: height! / 80.0),
                                  ...
                                  decoration:
                                      DesignConfig.boxDecorationContainer(
                                          Theme.of(context).colorScheme.onBackground,10.0),child: Column(children:[
                                  Padding(
                                    padding: EdgeInsetsDirectional.only(
                                      start: width! / 40.0,
                                      end: width! / 40.0,
                            ...
                            bottom: height! / 80.0),
                                  ...
                                  decoration:
                                      DesignConfig.boxDecorationContainer(
                                          Theme.of(context).colorScheme.onBackground,10.0),child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children:[
                                  Text(UiUtils.getTranslatedLabel(context, billDetailLabel),
                                      textAlign: TextAlign.start,
                                      style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 15, fontWeight: FontWeight.w700)),
                                  Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(children: [
                                      Text("${UiUtils.getTranslatedLabel(context, chargesAndTaxesLabel)} (${cartList.taxPercentage!}${StringsRes.percentSymbol})",
                                          textAlign: TextAlign.left, style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12)),
                                      const Spacer(),
                                          ...
                                          child: BlocConsumer<ValidatePromoCodeCubit, ValidatePromoCodeState>(
                                              ...
                                              listener: (context, state) {
                                                ...
                                                if (state is ValidatePromoCodeFetchSuccess) {
                                                  ...
                                                  print("${state.promoCodeValidateModel!.promoCode!.toString()}$finalTotal");
                                                }
                                              },
                                              builder: (context, state) {
                                                if (state is ValidatePromoCodeFetchSuccess) {
                                              ...
                                              return Padding(
                                                  ...
                                                  child: Column(children: [
                                                    ...
                                                    Row(children: [
                                                      ...
                                                      Text(
                                                          context.read<SystemConfigCubit>().getCurrency() +
                                                              (finalTotal + deliveryTip).toStringAsFixed(2),
                                                          textAlign: TextAlign.end,
                                                          style: TextStyle(
                                                              color: Theme.of(context).colorScheme.onSecondary,
                                                              fontSize: 15,
                                              ...
                                              return Padding(
                                                  ...
                                                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                                                    Row(children: [
                                                      ...
                                                      Text(
                                                          context.read<SystemConfigCubit>().getCurrency() +
                                                              (finalTotal + deliveryTip-promoAmt).toStringAsFixed(2),
                                                          textAlign: TextAlign.end,
                                                          style: TextStyle(
                                                              color: Theme.of(context).colorScheme.onSecondary,
                                                              fontSize: 15,
                                  ...
                                  orderTypeIndex.toString() == "0"
                                      ...
                                      : Padding(
                                          ...
                                          child: Row(children: [
                                            ...
                                            const Spacer(),
                                            Text(context.read<SystemConfigCubit>().getCurrency() + (finalTotal + deliveryTip).toStringAsFixed(2),
                                                textAlign: TextAlign.end,
                                                style: TextStyle(
                                                    color: Theme.of(context).colorScheme.onSecondary,
                                                    fontSize: 15,
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              appBar: DesignConfig.appBar(context, width!, restaurantName.toString(), PreferredSize(preferredSize: Size(width!, height!/70.0), child: Center(
                                                  ...
                                                  child: BlocBuilder<DeliveryChargeCubit, DeliveryChargeState>(
                                                                                                    ...
                                                                                                    builder: (context, state) {
                                                                                                      ...
                                                                                                      return ButtonContainer(
                                                                                                        ...
                                                                                                        textColor: white,
                                                                                                        onPressed: () {
                                                                                                          context.read<IsOrderDeliverableCubit>().fetchIsOrderDeliverable(context.read<GetCartCubit>().getCartModel().data![0].productDetails![0].partnerId, latitude.toString(), longitude.toString(), selAddress);
                                                                                                        },
                                                                                                      );
                                                                                                    }),
                                                );
              ...
              body: RefreshIndicator(onRefresh: refreshList, color: Theme.of(context).colorScheme.primary, child: Container(
