                                  ...
                                  child: ButtonImageContainer(
                                      ...
                                      onPressed: () {
                                        Navigator.of(context).pushNamed(Routes.orderTrackingDetail, arguments: {
                                                                  ...
                                                                  'partnerAddress':
                                                                      widget.partnerAddress!
                                                                });
                                      },
                                      widget: Icon(Icons.my_location_outlined, color: Theme.of(context).colorScheme.onBackground)),
                                ),
                            ...
                            child: Row(
                              children: [
                                Text(UiUtils.getTranslatedLabel(context, orderIdLabel),
                                    ...
                                    style:
                                        TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.w500,fontStyle:  FontStyle.normal,fontSize: 14.0)),
                                const Spacer(),
                                Text("#${orderList[0].id!}",
                                    textAlign: TextAlign.start,
                                    style: TextStyle(
                                        color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.w600, fontStyle:  FontStyle.normal,fontSize: 12.0)),
                              ],
                            ),
                          ),
                          Container(
                              ...
                              child: ListView.builder(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              SizedBox(width:width!/4.0,
                                                child: Text(outputDate,
                                                              textAlign: TextAlign.center,
                                                              style: TextStyle(
                                                                  color: Theme.of(context).colorScheme.onSecondary,
                                                                  fontWeight: FontWeight.w500,fontStyle:  FontStyle.normal,fontSize: 12.0), maxLines: 2,),
                                              ),
                                              Column(children:[
                                              Container(width: width!/30.0, height: height!/5.5, margin: EdgeInsetsDirectional.only(start: width!/80.0, end: width!/30.0), decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.secondary, 10.0)),
                                              Container(width: 10.0, height: 10.0, margin: EdgeInsetsDirectional.only(start: width!/80.0, end: width!/30.0), decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.secondary, 5.0)),
                                              ]),
                                              Flexible(
                                                child: Column(
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  ...
                                                  height: 36.0,
                                                  width: 36,
                                                  decoration: DesignConfig.boxDecorationContainer(orderList[0].status![index][0] == pendingKey?orderTrackingCardYellowColor:orderList[0].status![index][0] == confirmedKey?orderTrackingCardGreenColor.withOpacity(0.30):orderList[0].status![index][0] == preparingKey?orderTrackingCardRedColor.withOpacity(0.30):orderList[0].status![index][0] == outForDeliveryKey?orderTrackingCardPeachColor:orderTrackingCardYellowColor, 5.0),
                                                  child: SvgPicture.asset(
                                                    DesignConfig.setSvgPath(orderList[0].status![index][0] == pendingKey?"order_place":orderList[0].status![index][0] == confirmedKey?"order_confirmed":orderList[0].status![index][0] == preparingKey?"order_prepared":orderList[0].status![index][0] == outForDeliveryKey?"order_of_for_delivery":""),
                                                    width: 24,
                                                    height: 24)),
                                                    ...
                                                    Row(children:[
                                                      Text("${UiUtils.getTranslatedLabel(context, statusLabel)}: ",
                                                        ...
                                                        style: TextStyle(
                                                            color: Theme.of(context).colorScheme.onSecondary,
                                                            fontWeight: FontWeight.w600,fontStyle:  FontStyle.normal,fontSize: 12.0)),
                                                      Text("${UiUtils.getTranslatedLabel(context, orderLabel)} $status",
                                                        textAlign: TextAlign.start,
                                                        style: TextStyle(
                                                            color: orderList[0].status![index][0] == pendingKey?yellowColor:orderList[0].status![index][0] == confirmedKey?orderTrackingCardGreenColor:orderList[0].status![index][0] == preparingKey?orderTrackingCardRedColor:orderList[0].status![index][0] == outForDeliveryKey?orderTrackingCardOrangeColor:orderTrackingCardYellowColor,
                                                            fontSize: 12,
                                  ...
                                  Container(width: width!/30.0, height: height!/5.5, margin: EdgeInsetsDirectional.only(start: width!/3.2, end: width!/30.0), decoration: DesignConfig.boxDecorationContainer(timeLineColor, 10.0)),
                                  Flexible(
                                                child: Column(
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                    ...
                                                    Row(children:[
                                                      Text("${UiUtils.getTranslatedLabel(context, statusLabel)}: ",
                                                        ...
                                                        style: TextStyle(
                                                            color: Theme.of(context).colorScheme.onSecondary,
                                                            fontWeight: FontWeight.w600,fontStyle:  FontStyle.normal,fontSize: 12.0)),
                                                      Text("${UiUtils.getTranslatedLabel(context, orderLabel)} ${UiUtils.getTranslatedLabel(context, deliveryLabel)}",
                                                        textAlign: TextAlign.start,
                                                        style: const TextStyle(
                                                            ...
                                                            fontWeight: FontWeight.w500))]),
                                                    const SizedBox(height: 1.0),
                                                    Text("${UiUtils.getTranslatedLabel(context, yourOrderLabel)} ${UiUtils.getTranslatedLabel(context, deliveredLabel)}",
                                                        textAlign: TextAlign.start,
                                                        style: TextStyle(
                                                            color: Theme.of(context).colorScheme.onSecondary,
                                                            fontWeight: FontWeight.w400,fontStyle:  FontStyle.normal,fontSize: 12.0)),
