...
import 'package:erestro/ui/widgets/simmer/orderDetailSimmer.dart';
...
class OrderDetailScreen extends StatefulWidget {
  ...
  const OrderDetailScreen(
      {Key? key, this.id, this.riderId, this.riderName, this.riderRating, this.riderImage, this.riderMobile, this.riderNoOfRating, this.isSelfPickup, this.from})
      : super(key: key);
    ...
    return FutureBuilder<List<Directory>?>(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          return /*_isProgress
              ...
              : */
              ButtonContainer(color: Theme.of(context).colorScheme.secondary, height: height, width: width, text: UiUtils.getTranslatedLabel(context, downloadBillLabel), start: width! / 40.0, end: width! / 40.0, bottom: height! / 55.0, top: 0, status: _isProgress,borderColor: Theme.of(context).colorScheme.secondary, textColor: white, onPressed: () async {
                      setState(() {
                        _isProgress = true;
                      });
                          ...
                          children: [
                            orderList[index].activeStatus == cancelledKey
                                ...
                                : orderList[index].isSelfPickUp == "1"
                                    ? const SizedBox()
                                    : Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0),
                                        ...
                                        child: Row(children: [
                                          Text(UiUtils.getTranslatedLabel(context, otpLabel),
                                              textAlign: TextAlign.left, style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontStyle:  FontStyle.normal,
                                              fontSize: 14.0, fontWeight: FontWeight.w500,)),
                                          const Spacer(),
                                          Text(orderList[index].otp!,
                                              textAlign: TextAlign.right,
                                              style: TextStyle(
                                                  color: Theme.of(context).colorScheme.primary, fontSize: 12, fontWeight: FontWeight.w600, letterSpacing: 0.8, fontStyle:  FontStyle.normal)),
                                        ]),
                                      ),
                                      Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0), padding: EdgeInsetsDirectional.only(top: height!/80, start: width!/40.0, end: width!/40.0, bottom: height!/80.0),
                                    child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children:[
                                        Text(UiUtils.getTranslatedLabel(context, orderFromLabel),
                                              style: TextStyle(
                                      ...
                                      Text(orderList[index].orderItems![0].partnerDetails![0].partnerName!,
                                            ...
                                            style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 16.0, fontWeight: FontWeight.w700, fontStyle:  FontStyle.normal)),
                                            ...
                                            Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0), margin: EdgeInsetsDirectional.only(top: height!/60.0), padding: EdgeInsetsDirectional.only(top: height!/80, start: width!/40.0, end: width!/40.0, bottom: height!/80.0),
                                              child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                ...
                                                children: [
                                                  Container(
                                                      ...
                                                      child: Icon(Icons.check, color: Theme.of(context).colorScheme.onBackground)),
                                                  Expanded(
                                                    child: Column(
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        ...
                                                        children: [
                                                          Text("${UiUtils.getTranslatedLabel(context, orderLabel)} ${orderList[index].activeStatus!}",
                                                              textAlign: TextAlign.start,
                                                              style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.w500, fontStyle:  FontStyle.normal)),
                                                          Text("${UiUtils.getTranslatedLabel(context, yourOrderLabel)} ${orderList[index].activeStatus!}",
                                                              textAlign: TextAlign.start,
                                                              style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 10, fontWeight: FontWeight.w400, fontStyle:  FontStyle.normal)),
                                              ...
                                              (orderList[index].reason!.isEmpty || orderList[index].reason == "")
                                                ...
                                                : Text("${UiUtils.getTranslatedLabel(context, orderCancelDueToLabel)} ${orderList[index].reason}",
                                                    textAlign: TextAlign.start,
                                                    maxLines: 2,
                                                    style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w400)),
                                              ])
                                            ),    
                            orderList[index].isSelfPickUp == "0"
                                ...
                                : orderList[index].ownerNote!.isEmpty
                                    ...
                                    :Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0), margin: EdgeInsetsDirectional.only(top: height!/60.0), padding: EdgeInsetsDirectional.only(top: height!/80, start: width!/40.0, end: width!/40.0, bottom: height!/80.0),
                                    child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children:[
                                        Text(UiUtils.getTranslatedLabel(context, partnerNoteLabel),
                                              style: TextStyle(
                                              fontSize: 14, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.w500),
                                            ),
                                      Padding(
                            ...
                            orderList[index].isSelfPickUp == "0"
                                ...
                                : orderList[index].selfPickupTime!.isEmpty
                                    ...
                                    : Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0), margin: EdgeInsetsDirectional.only(top: height!/60.0), padding: EdgeInsetsDirectional.only(top: height!/80, start: width!/40.0, end: width!/40.0, bottom: height!/80.0),
                                    child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children:[
                                        Text(UiUtils.getTranslatedLabel(context, pickupTimeLabel),
                                              style: TextStyle(
                                              fontSize: 14, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.w500),
                                            ),
                                      Padding(
                                    ...
                                    child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children:[
                                        Row(
                                          children: [
                                            Text(UiUtils.getTranslatedLabel(context, orderDetailsLabel),
                                                  style: TextStyle(
                                                  fontSize: 14, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.w500),
                                                ),
                                                const Spacer(),
                                              ...
                                              child: Column(mainAxisSize: MainAxisSize.min,
                                                  ...
                                                  children: [
                                                    ...
                                                    orderList[index].orderItems![i].attrName != ""
                                                        ? Container(margin: EdgeInsetsDirectional.only(start: width!/16.0),
                                                          child: Row(
                                                              mainAxisAlignment: MainAxisAlignment.start,
                                                              crossAxisAlignment: CrossAxisAlignment.start,
                                                              children: [
                            ...
                            Row(children: [
                              Text(UiUtils.getTranslatedLabel(context, subTotalLabel),
                                  textAlign: TextAlign.left,
                                  style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.w700, fontStyle:  FontStyle.normal)),
                              const Spacer(),
                              Text(
                                  context.read<SystemConfigCubit>().getCurrency() +
                                      (double.parse(orderList[index].total!) - double.parse(orderList[index].totalTaxAmount!)).toStringAsFixed(2),
                                  textAlign: TextAlign.end,
                                  style: TextStyle(
                                      color: Theme.of(context).colorScheme.onSecondary,
                                      fontSize: 12, fontWeight: FontWeight.w700, fontStyle:  FontStyle.normal)),
                            ]),
                            const SizedBox(height: 4.0),
                            Row(children: [
                              Text("${UiUtils.getTranslatedLabel(context, chargesAndTaxesLabel)} (${orderList[index].totalTaxPercent!}${StringsRes.percentSymbol})",
                                  textAlign: TextAlign.left, style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w400, fontStyle:  FontStyle.normal)),
                              const Spacer(),
                              Text(context.read<SystemConfigCubit>().getCurrency() + orderList[index].totalTaxAmount!,
                                  textAlign: TextAlign.right,
                                  style: TextStyle(color: Theme.of(context).colorScheme.primary, fontSize: 12, fontWeight: FontWeight.w600, fontStyle:  FontStyle.normal)),
                            ]),
                            const Padding(
                            ...
                            Row(children: [
                              Text(UiUtils.getTranslatedLabel(context, totalLabel),
                                  textAlign: TextAlign.left,
                                  style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w700, fontStyle:  FontStyle.normal)),
                              const Spacer(),
                              Text("${context.read<SystemConfigCubit>().getCurrency()} ${orderList[index].total!}",
                                  textAlign: TextAlign.right,
                                  style: TextStyle(
                                      color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w700, fontStyle:  FontStyle.normal)),
                            ]),
                            const Padding(
                              padding: EdgeInsetsDirectional.only(top: 4.5, bottom: 4.5),
                              child: DashLineView(
                                ...
                                ? Padding(
                                    ...
                                    child: Row(children: [
                                      ...
                                      Text(" - ${context.read<SystemConfigCubit>().getCurrency()} ${orderList[index].promoDiscount!}",
                                          textAlign: TextAlign.right,
                                          style:
                                              TextStyle(color: Theme.of(context).colorScheme.primary, fontSize: 12, fontWeight: FontWeight.w600, fontStyle:  FontStyle.normal)),
                                    ]),
                                  )
                                : Container(),
                            orderList[index].deliveryTip=="0"?const SizedBox():Row(children: [
                            ...
                            orderList[index].walletBalance=="0"?const SizedBox() : Padding(
                              ...
                              child: Row(children: [
                                Text(UiUtils.getTranslatedLabel(context, useWalletLabel),
                                    textAlign: TextAlign.left, style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w400, fontStyle:  FontStyle.normal)),
                                const Spacer(),
                                Text(" - ${context.read<SystemConfigCubit>().getCurrency()} ${double.parse(orderList[index].walletBalance!).toStringAsFixed(2)}",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(color: Theme.of(context).colorScheme.primary, fontSize: 12, fontWeight: FontWeight.w600, fontStyle:  FontStyle.normal)),
                              ]),
                            ),
                            ...
                            Row(children: [
                              Text(UiUtils.getTranslatedLabel(context, totalPayLabel),
                                  ...
                                  style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w700, fontStyle:  FontStyle.normal)),
                              const Spacer(),
                              Text("${context.read<SystemConfigCubit>().getCurrency()} ${double.parse(orderList[index].totalPayable!).toStringAsFixed(2)}",
                                  textAlign: TextAlign.right,
                                  style: TextStyle(
                                      color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w700, fontStyle:  FontStyle.normal)),
                            ]),
                            ...
                            Row(children: [
                              Text(UiUtils.getTranslatedLabel(context, paymentLabel),
                                  textAlign: TextAlign.left,
                                  style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12, fontWeight: FontWeight.w400, fontStyle:  FontStyle.normal)),
                              const Spacer(),
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : WillPopScope(onWillPop: (){
            ...
            child: Scaffold(
                appBar: DesignConfig.appBar(context, width!, widget.from=="orderDeliverd"?UiUtils.getTranslatedLabel(context, orderDeliveredLabel):UiUtils.getTranslatedLabel(context, orderDetailsLabel), const PreferredSize(
                                  preferredSize: Size.zero,child:SizedBox()), status: widget.from=="orderSuccess"?true:false),
                bottomNavigationBar: (widget.from=="orderDeliverd" && widget.isSelfPickup == "0"
                  ...
                  GestureDetector(
                      ...
                      child: Text(UiUtils.getTranslatedLabel(context, reviewLabel),
                          textAlign: TextAlign.center, style: TextStyle(color: Theme.of(context).colorScheme.primary, fontSize: 16, fontWeight: FontWeight.w700))),
                  ...
                  widget.isSelfPickup == "1"
                      ? Row(
                          children: [
                            Expanded(
                              child: ButtonContainer(color: Theme.of(context).colorScheme.secondary, height: height, width: width, text: UiUtils.getTranslatedLabel(context, getDirectionLabel), start: width! / 40.0, end: width! / 40.0, bottom: height! / 99.0, top: 0, status: false, borderColor: Theme.of(context).colorScheme.secondary, textColor: white, onPressed: (){
                         launchMap(latitude, longitude);
                      },),
                            ),
                            Expanded(
                              child: ButtonContainer(color: Theme.of(context).colorScheme.secondary, height: height, width: width, text: UiUtils.getTranslatedLabel(context, callToRestaurantsLabel), start: width! / 40.0, end: width! / 40.0, bottom: height! / 99.0, top: 0, status: false, borderColor: Theme.of(context).colorScheme.secondary, textColor: white, onPressed: () async {
                ...
                body: Container(
                  margin: EdgeInsetsDirectional.only(top: height! / 80.0), padding: EdgeInsetsDirectional.only(start: width! / 40.0, end: width! / 40.0),
                  width: width,
                  child: orderData(),
                )),
          ),
