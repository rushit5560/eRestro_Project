...
import 'package:erestro/ui/widgets/simmer/myOrderSimmer.dart';
import 'package:erestro/ui/widgets/noDataContainer.dart';
import 'package:erestro/ui/widgets/smallButtomContainer.dart';
    ...
    return showDialog(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
          return AlertDialog(
            shape: DesignConfig.setRoundedBorder(Theme.of(context).colorScheme.onBackground, 25.0, false),
                                  ...
                                  Expanded(
                                      child: InkWell(
                                          ...
                                          child: Container(
                                              ...
                                              decoration: DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.onSecondary, Theme.of(context).colorScheme.onBackground, 100.0),
                              ...
                              Expanded(
                                  ...
                                  child: InkWell(
                                      ...
                                      child: Container(
                                          ...
                                          decoration: DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.secondary, Theme.of(context).colorScheme.onBackground, 100.0),
                                      ...
                                      child: Column(
                                        children: [
                                          Container(decoration: DesignConfig.boxDecorationContainerHalf(
                                           Theme.of(context).colorScheme.onBackground), padding: EdgeInsetsDirectional.only(
                                        ...
                                        child: ListView.builder(shrinkWrap: true,
                                          ...
                                          Row(mainAxisAlignment: MainAxisAlignment.end,
                                            children: [
                                              orderList[index].activeStatus == preparingKey?const SizedBox():SmallButtonContainer(color: Theme.of(context).colorScheme.onBackground, height: height, width: width, text: orderList[index].activeStatus == deliveredKey
                                                      ? UiUtils.getTranslatedLabel(context, rateLabel): cancelStatus[k] == true?UiUtils.getTranslatedLabel(context, cancelLabel):"", start: width! / 40.0, end: width! / 99.0, bottom: 0, top: 0, radius: 5.0, status: false,borderColor: orderList[index].activeStatus == deliveredKey
                                                      || cancelStatus[k] == true?Theme.of(context).colorScheme.secondary:Theme.of(context).colorScheme.onBackground, textColor: Theme.of(context).colorScheme.onSecondary, onTap: (){
                                                        if (mounted) {
                                                      ...
                                                      if (orderList[index].activeStatus == deliveredKey) {
                                                        ...
                                                        if(orderList[index].activeStatus==cancelledKey){
                                                          UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, orderLabel), StringsRes.orderCantCancel, context, false, type: "2");
                                                        }else{cancel(context, cancelledKey, orderList[index].id!);}
                                                      } else {
                                              ...
                                              BlocConsumer<ManageCartCubit, ManageCartState>(
                                                  ...
                                                  builder: (context, state) {
                                                    return SmallButtonContainer(color: Theme.of(context).colorScheme.secondary, height: height, width: width, text: orderList[index].activeStatus == outForDeliveryKey
                                                                    ...
                                                                    : UiUtils.getTranslatedLabel(context, reOrderLabel), start: width! / 99.0, end: width! / 40.0, bottom: 0, top: 0, radius: 5.0, status: false,borderColor: Theme.of(context).colorScheme.secondary, textColor: white, onTap: (){
