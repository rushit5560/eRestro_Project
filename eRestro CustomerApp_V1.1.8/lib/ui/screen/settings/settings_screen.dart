...
import 'package:erestro/ui/screen/settings/refer_and_earn_screen.dart';
import 'package:erestro/ui/screen/settings/no_internet_screen.dart';
import 'package:erestro/ui/widgets/LanguageDialog.dart';
...
class SettingsScreenState extends State<SettingsScreen> {
 ...
 Widget languageChange() {
  ...
  Widget arrowTile({String? name, VoidCallback? onPressed, String? image, IconData? iconData}) {
    return GestureDetector(
      onTap: onPressed,
      child:  Container(decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0), padding: const EdgeInsetsDirectional.all(10.0),margin: EdgeInsetsDirectional.only(top: height! / 99.0, bottom: height! / 99.0, start: width!/60.0, end: width!/60.0),
        child: ListTile(
            leading: CircleAvatar(
              ...
              child: image != null && image != ""
                  ...
                  : Icon(iconData, color: Theme.of(context).colorScheme.onBackground),
            ),
            dense: true,
            contentPadding: EdgeInsets.zero,
            visualDensity: const VisualDensity(horizontal: 0, vertical: -4),
