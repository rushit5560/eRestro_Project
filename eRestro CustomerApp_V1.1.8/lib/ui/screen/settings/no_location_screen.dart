                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.gps_fixed, color: Theme.of(context).colorScheme.onBackground),
          ...
          getPlaceDetailWithLatLng: (p) async {
            ...
            if (mounted) {
              setState(() {
                ...
                setAddressForDisplayData(context, "1",localities.join("").toString(),detail.result.geometry!.location.lat.toString(),detail.result.geometry!.location.lng.toString(),detail.result.formattedAddress!.toString());}
              });
            }
          },
          itmClick: (p) async {
