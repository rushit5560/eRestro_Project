...
import 'package:erestro/cubit/helpAndSupport/addTicketCubit.dart';
import 'package:erestro/cubit/helpAndSupport/editTicketCubit.dart';
import 'package:erestro/cubit/helpAndSupport/helpAndSupportCubit.dart';
import 'package:erestro/cubit/helpAndSupport/ticketCubit.dart';
import 'package:erestro/data/model/ticketStatusType.dart';
import 'package:erestro/data/repositories/helpAndSupport/helpAndSupportRepository.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Container(padding: EdgeInsetsDirectional.only(start: width! / 30.0, end: width! / 30.0, top: height! / 80.0, bottom: height!/80.0), decoration: DesignConfig.boxDecorationContainer(
                                  Theme.of(context).colorScheme.onBackground, 10.0), child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
