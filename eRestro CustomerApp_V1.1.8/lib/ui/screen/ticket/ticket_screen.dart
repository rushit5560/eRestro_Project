  ...
  Widget ticket() {
    return BlocConsumer<TicketCubit, TicketState>(
        ...
        builder: (context, state) {
          print("stateScreen:${state.toString()}");
