...
import 'package:erestro/cubit/transaction/transactionCubit.dart';
...
import 'package:erestro/ui/widgets/transactionContainer.dart';
              ...
              Container(alignment: Alignment.centerLeft, padding: EdgeInsetsDirectional.only(start: width!/20.0), decoration: DesignConfig.boxDecorationContainerHalf(Theme.of(context).colorScheme.onSecondary), height: height!/15.0, width: width!, child: Text(
                ...
                textAlign: TextAlign.left                
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      SmallButtonContainer(color: Theme.of(context).colorScheme.onBackground, height: height, width: width, text: UiUtils.getTranslatedLabel(context, cancelLabel), start: 0, end: 0, bottom: height!/60.0, top: height!/99.0, radius: 5.0, status: false,borderColor: Theme.of(context).colorScheme.onBackground, textColor: Theme.of(context).colorScheme.onSecondary, onTap: (){
          ...
          : Scaffold(
              ...
              child: Container(
                  ...
                  child: SingleChildScrollView( physics: const NeverScrollableScrollPhysics(),
                    child: Column(
                      children: [
                        Container(padding: EdgeInsetsDirectional.only(start: width! / 30.0, end: width! / 30.0, top: height! / 80.0, bottom: height!/80.0), decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onBackground, 10.0),
                                ...
                                BlocBuilder<SystemConfigCubit, SystemConfigState>(
                                    ...
                                    builder: (context, state) {
                                      if (state is SystemConfigFetchSuccess) {
                                        ...
                                        return Text("${context.read<SystemConfigCubit>().getCurrency()}${double.parse(walletAmount!).toStringAsFixed(2)}",
                                          style: const TextStyle(
                                          color:  Colors.white,
                                          fontWeight: FontWeight.w600,
                                          fontStyle:  FontStyle.normal,
                                ...
                                child: Container(
                                  ...
                                  decoration:
                                      Directionality.of(context) == ui.TextDirection.rtl
                                          ...
                                          Theme.of(context).colorScheme.onBackground.withOpacity(0.10), 0, 0, 10, 62):DesignConfig.boxDecorationContainerRoundHalf(
                              ...
                              Positioned.directional(start: width!/30.0,
                                ...
                                child: Container(
                                  ...
                                  decoration:
                                      Directionality.of(context) == ui.TextDirection.rtl
                                              ? DesignConfig.boxDecorationContainerRoundHalf(
                                          Theme.of(context).colorScheme.onBackground.withOpacity(0.10), 62, 10, 0, 0):DesignConfig.boxDecorationContainerRoundHalf(
