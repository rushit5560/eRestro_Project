      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end,
            children: [
              widget.from=="skip"?SmallButtonContainer(color: Theme.of(context).colorScheme.onBackground, height: widget.height, width: widget.width, text: UiUtils.getTranslatedLabel(context, cancelLabel), start: 0, end: 0, bottom: widget.height!/60.0, top: widget.height!/99.0, radius: 5.0, status: false,borderColor: Theme.of(context).colorScheme.onBackground, textColor: Theme.of(context).colorScheme.onSecondary, onTap: () async {
