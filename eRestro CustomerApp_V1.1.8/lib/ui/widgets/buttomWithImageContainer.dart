    ...
    return Padding(
      ...
      child: SizedBox(height: widget.height!/15.0,
        child: TextButton(
          ...
          child: widget.status == true? CircularProgressIndicator(color: Theme.of(context).colorScheme.onBackground):Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              widget.widget!,
