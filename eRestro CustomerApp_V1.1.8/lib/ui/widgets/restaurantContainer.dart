                      ...
                      child: BlocBuilder<AuthCubit, AuthState>(builder: (context, state) {
                                      ...
                                      return BlocConsumer<UpdateRestaurantFavoriteStatusCubit, UpdateRestaurantFavoriteStatusState>(
                                        ...
                                        builder: (context, state) {
                                          if (state is UpdateRestaurantFavoriteStatusInProgress) {
                                            return Container(width: 30.0, height: 30, margin: const EdgeInsetsDirectional.only(end: 5.0, top: 5),
                                                  child: ClipOval(
                            ...
                            child: BackdropFilter(
                                ...
                                child: Container(
                                  ...
                                  child:SvgPicture.asset(DesignConfig.setSvgPath("wishlist-filled"), fit: BoxFit.scaleDown, width: 18.0, height: 18.3))),
                            ...
                            child: BackdropFilter(
                                ...
                                child: Container(
                                  ...
                                  child:SvgPicture.asset(DesignConfig.setSvgPath("wishlist1"), fit: BoxFit.scaleDown, width: 18.0, height: 18.3))),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        restaurant.tags!.isNotEmpty?Text(restaurant.tags!.join(', '),
                        ...
                        Text("${context.read<SystemConfigCubit>().getCurrency()}${
                                restaurant.priceForOne!} ${UiUtils.getTranslatedLabel(context, forOneLabel)}",
                                textAlign: TextAlign.start,
                                style: TextStyle(
                                    color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.w600, fontStyle: FontStyle.normal, overflow: TextOverflow.ellipsis),
                                  maxLines: 2,),
                        const SizedBox(height: 2.0),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          children: [
                            double.parse(restaurant.partnerRating!).toStringAsFixed(1)=="0.0"?const SizedBox():Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                ...
                                Text(double.parse(restaurant.partnerRating!).toStringAsFixed(1),
                                    ...
                                    style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.normal)),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Theme.of(context).colorScheme.onSecondary, fontSize: 14, fontWeight: FontWeight.normal, overflow: TextOverflow.ellipsis),
                                  maxLines: 2,
                                ),
                              ],
                            ),
