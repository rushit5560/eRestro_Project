                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                                child: Text(widget.productDetailsModel.name!,
                                                  ...
                                                  builder: (context, state) {
                                                    if (state is UpdateProductFavoriteStatusInProgress) {
                                                      return Container(
                                                          ...
                                                          decoration: DesignConfig.boxDecorationCircle(Theme.of(context).colorScheme.background,
                                                              Theme.of(context).colorScheme.background, 50.0),
                                              ...
                                              return InkWell(
                                                  ...
                                                  child: Container(
                                                      ...
                                                      decoration: DesignConfig.boxDecorationCircle(
                                                          Theme.of(context).colorScheme.background, Theme.of(context).colorScheme.background, 10.0),
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: InkWell(
                                                    onTap: widget.qty! > 1
                                                        ? () {
                                                            setState(() {
                                                              if (widget.qty! <= int.parse(widget.productDetailsModel.minimumOrderQuantity!)) {
                                                                ...
                                                                widget.qty =
                                                                    widget.qty! - 1 /*  - int.parse(widget.productDetailsModel.quantityStepSize!) */;
                                                              }
                                                              print("data");
                                              ...
                                              Text(widget.qtyData[widget.productVariantId!].toString(),
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                                                    color: Theme.of(context).colorScheme.onSecondary,
                                                    fontSize: 14,
                        ...
                        BlocBuilder<AuthCubit, AuthState>(builder: (context, state) {
                          var sum = 0.0;
                          for (var i = 0; i < widget.addOnPrice.length; i++) {
                            sum += widget.addOnPrice[i]*widget.qtyData[widget.productVariantId!]!;
                          }
                                                              ...
                                                              context.read<ManageCartCubit>().manageCartUser(
                                                                  ...
                                                                  qty: widget.from == "cart"
                                                                      ...
                                                                      : (int.parse(widget
                                                                                  .productDetailsModel.variants![widget.currentIndex!].cartCount!) +
                                                                              int.parse(widget.qtyData[widget.productVariantId!].toString()))
                                                                          .toString(), //widget.qtyData[widget.productVariantId!].toString(), //widget.qtyData[widget.productVariantId!].toString(),
                                                                  addOnId: widget.addOnIds.isNotEmpty ? widget.addOnIds.join(",").toString() : "",
                                                                  addOnQty: widget.addOnQty.isNotEmpty ? widget.addOnQty.join(",").toString() : "");
                                                            }
                                                          }
