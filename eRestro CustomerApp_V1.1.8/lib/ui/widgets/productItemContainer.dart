                    ...
                    child: widget.dataItem.partnerDetails![0].isRestroOpen == "1"
                            ...
                            child: /* widget.dataItem.variants![0].cartCount == "0"
                                ?  */Container(
                                    ...
                                    decoration: DesignConfig.boxDecorationContainerBorder(
                                        Theme.of(context).colorScheme.primary, Theme.of(context).colorScheme.onBackground, 5.0),
                        ...
                        : InkWell(
                            ...
                            child: Container(
                                ...
                                height: widget.height! / 22,
                                decoration:
                                    DesignConfig.boxDecorationContainerBorder(commentBoxBorderColor, Theme.of(context).colorScheme.onBackground, 5.0),
                                child: Text(UiUtils.getTranslatedLabel(context, addLabel),
                                    style: TextStyle(
                                        color: Theme.of(context).colorScheme.onSecondary,
                                        fontWeight: FontWeight.w600,
