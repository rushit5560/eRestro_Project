...
import 'package:erestro/data/model/transactionModel.dart';
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          decoration: DesignConfig.boxDecorationContainerBorder(
                              transactionModel.status == successKey ? Theme.of(context).colorScheme.onPrimary : Theme.of(context).colorScheme.error,
                              transactionModel.status == successKey
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                                fontSize: 10,
                                color: transactionModel.status == successKey
